        ...
        <div className="footer__grid">
          ...
          <div className="footer__socials" style={{ flexDirection: 'column', gap: 8 }}>
            <div style={{ display: 'flex', gap: 8 }}>
              <button className="footer__social line" title="LINE"><I name="line" size={18} /></button>
              <button className="footer__social fb" title="Facebook"><I name="facebook" size={18} /></button>
              <button className="footer__social" title="Instagram"><I name="instagram" size={18} /></button>
            </div>
          </div>
        </div>
