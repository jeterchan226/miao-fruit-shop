...
class Order(Base):
    ...
    transfer_last5: Mapped[str | None] = mapped_column(default=None)
    transfer_payer_name: Mapped[str | None] = mapped_column(default=None)
    transfer_note: Mapped[str | None] = mapped_column(Text, default=None)
